...
<body>
    <header class="builder-header">
        <div class="builder-header-left">
            <div class="builder-header-title">
                ...
                <span>FileCarousel Config Builder</span>
            </div>
    ...
    <script type="module">
        ...
        let currentTheme = localStorage.getItem('fc-config-builder-theme') || 'system';

        function applyTheme(theme) {
            currentTheme = theme;
            localStorage.setItem('fc-config-builder-theme', theme);

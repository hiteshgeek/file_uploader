<?php
/**
 * FileCarousel Sidebar Component
...
.demo-sidebar {
    width: 280px;
    background: linear-gradient(180deg, #0d5c4e 0%, #11998e 100%);
    color: #e2e8f0;
    padding: 0;
    position: fixed;
    top: 0;
...
<aside class="demo-sidebar">
    <div class="demo-sidebar-header">
        <a href="../index.php" class="demo-sidebar-logo">
            ...
            <span class="demo-sidebar-logo-text">File<span>Carousel</span></span>
        </a>
    </div>
...
function getSidebarIcon($icon) {
    $icons = [
        ...
        'file' => '<svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" stroke="currentColor" stroke-width="2" fill="none"/><path d="M14 2v6h6" stroke="currentColor" stroke-width="2" fill="none"/></svg>',
        'link' => '<svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/></svg>',
    ];

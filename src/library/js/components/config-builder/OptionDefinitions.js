    ...
    urls: {
      ...
      options: {
        ...
        additionalData: {
          type: "keyValue",
          default: {},
          label: "Global Data (All Requests)",
          hint: "Included in every POST request",
          group: "Request Data",
        },
        uploadData: {
          type: "keyValue",
        ...
        downloadData: {
          ...
          default: {},
          label: "Download Data",
          hint: "Only for download requests",
          group: "Request Data",
        },
        copyData: {
          type: "keyValue",
    ...
    mediaCapture: {
      ...
      options: {
        ...
        showRecordingTime: {
          type: "boolean",
          default: true,
          label: "Show Recording Time",
          hint: "Show elapsed/remaining time in the recording indicator",
          showWhen: (config) => config.enableVideoRecording || config.enableAudioRecording,
          group: "Timer Display",
        },
        showRecordingLimit: {
          type: "boolean",
          default: true,
          label: "Show Time Limit",
          hint: "Show the maximum recording duration in the timer",
          showWhen: (config) => config.enableVideoRecording || config.enableAudioRecording,
          dependsOn: "showRecordingTime",
          group: "Timer Display",
        },
        showRecordingSize: {
          type: "boolean",
        ...
        recordingTimeClickToggle: {
          type: "boolean",
          default: true,
          label: "Click to Toggle Time View",
          hint: "Allow clicking on the timer to toggle between elapsed and remaining time",
          showWhen: (config) => (config.enableVideoRecording || config.enableAudioRecording) && config.showRecordingTime && config.showRecordingLimit,
          dependsOn: "showRecordingTime",
          group: "Timer Display",
        },
        recordingTimeDefaultView: {
          type: "select",
          default: "elapsed",
          label: "Default Time Display",
          hint: "Initial time display mode when recording starts",
          options: [
            { value: "elapsed", label: "Elapsed Time (00:00 / 05:00)" },
            { value: "remaining", label: "Remaining Time (-05:00 / 05:00)" },
          ],
          showWhen: (config) => (config.enableVideoRecording || config.enableAudioRecording) && config.showRecordingTime,
          dependsOn: "showRecordingTime",
          group: "Timer Display",
        },
      },

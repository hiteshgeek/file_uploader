...
<body>
    <div class="demo-layout">
        ...
        <div class="card mt-4 mb-4">
            <div class="card-header bg-primary text-white">
                <h3 class="mb-0">Document Submission</h3>
            </div>
            <div class="card-body">
                <form id="submissionForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#uploadModal" id="openModalBtn">
                            ...
                            <div class="file-preview-summary" id="filePreviewSummary">
                                ...
                                <a class="edit-files-link" data-bs-toggle="modal" data-bs-target="#uploadModal">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="form-label text-muted text-uppercase small">Attachments</label>
                    <div id="modalFileUploader"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="saveModalBtn">Done</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="module">
        ...
        function initModalUploader() {
            ...
            uploadModal.addEventListener('hidden.bs.modal', updatePreviewSummary);

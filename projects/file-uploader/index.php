...
<body>
    <header class="hero">
        ...
        <div class="hero-buttons">
            <a href="usage/demo-modular-library.php" class="hero-btn hero-btn-primary">
            ...
            <a href="setup-guide.php" class="hero-btn hero-btn-secondary">
    ...
    <main class="container">
        ...
        <section class="tools-section">
            ...
            <div class="tools-grid">
                ...
                <a href="setup-guide.php" class="tool-link">
                    <svg viewBox="0 0 24 24" fill="none" stroke-width="2"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" stroke="currentColor"/></svg>
    ...
    <footer>
        <p>FileUploader Library &copy; <?= date('Y') ?> | <a href="../DOCUMENTATION.md">Documentation</a></p>
    </footer>
</body>
</html>
...
function getCardIcon($icon) {
    $icons = [
        ...
        'modules' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>',
    ];

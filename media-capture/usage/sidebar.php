<?php
/**
 * MediaCapture Sidebar Component
...
.demo-sidebar {
    width: 280px;
    background: linear-gradient(180deg, #9d174d 0%, #f5576c 100%);
    color: #e2e8f0;
    padding: 0;
    position: fixed;
    top: 0;
...
<aside class="demo-sidebar">
    <div class="demo-sidebar-header">
        <a href="../index.php" class="demo-sidebar-logo">
            ...
            <span class="demo-sidebar-logo-text">Media<span>Capture</span></span>
        </a>
    </div>
...
function getSidebarIcon($icon) {
    $icons = [
        'camera' => '<svg viewBox="0 0 24 24" fill="none"><path d="M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="13" r="4" stroke="currentColor" stroke-width="2"/></svg>',
        'video' => '<svg viewBox="0 0 24 24" fill="none"><polygon points="23 7 16 12 23 17 23 7" stroke="currentColor" stroke-width="2"/><rect x="1" y="5" width="15" height="14" rx="2" stroke="currentColor" stroke-width="2"/></svg>',
        'mic' => '<svg viewBox="0 0 24 24" fill="none"><path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z" stroke="currentColor" stroke-width="2"/><path d="M19 10v2a7 7 0 01-14 0v-2" stroke="currentColor" stroke-width="2"/><line x1="12" y1="19" x2="12" y2="23" stroke="currentColor" stroke-width="2"/><line x1="8" y1="23" x2="16" y2="23" stroke="currentColor" stroke-width="2"/></svg>',
